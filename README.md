...
Central
via [embedded browser](https://github.com/grisha9/easy-maven-plugin/wiki/Search-Dependency-in-Maven-Central-in-Browser).

Easy Maven plugin runs on top of pure Maven, without any hidden logic. It's a simple Maven Proxy for IDEA.
The philosophy of Easy Maven plugin: "everything is a Maven task". Any interaction with Maven: import project, test
execution, dependency analysis, debugging - is simply running the
