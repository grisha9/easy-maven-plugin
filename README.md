...
Easy Maven is lightweight plugin for IDEA that gets the project model through Maven task execution and provides a
convenient search for dependencies in Maven Central.
